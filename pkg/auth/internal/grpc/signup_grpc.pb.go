...
const (
	SignUp_SignUpUser_FullMethodName = "/SignUp/SignUpUser"
)
...
type SignUpClient interface {
	SignUpUser(ctx context.Context, in *RegisterUserRequest, opts ...grpc.CallOption) (*SignUpResponse, error)
}
...
func (c *signUpClient) SignUpUser(ctx context.Context, in *RegisterUserRequest, opts ...grpc.CallOption) (*SignUpResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SignUpResponse)
	err := c.cc.Invoke(ctx, SignUp_SignUpUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SignUpServer interface {
	SignUpUser(context.Context, *RegisterUserRequest) (*SignUpResponse, error)
...
func (UnimplementedSignUpServer) SignUpUser(context.Context, *RegisterUserRequest) (*SignUpResponse, error) {
...
func _SignUp_SignUpUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SignUpServer).SignUpUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SignUp_SignUpUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SignUpServer).SignUpUser(ctx, req.(*RegisterUserRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _SignUp_SignUpUser_Handler,
		},
	},
